  ...
  <div class="result-container">
    ...
    >
      <div class="result-header">
        ...
        <h1 class="result-title">Reviu Hasil Simulasi TKA SD</h1>
...
import '../../styles/sd-fulltest-result.css'
...
onMounted(() => {
  const saved = sessionStorage.getItem('sdFullTestResult')
