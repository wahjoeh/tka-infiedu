<template>
  <div class="smp-container">
    ...
    <div class="smp-card">
      ...
      <div class="mode-grid">
        <button class="mode-card" @click="goToPractice">
          <div class="mode-icon">📚</div>
          <h3>Latihan</h3>
          <p>Berlatih soal berdasarkan mata pelajaran</p>
        </button>

        <button class="mode-card" @click="goToTest">
          <div class="mode-icon">📝</div>
          <h3>Tes</h3>
          <p>Simulasi ujian dengan timer dan skor akhir</p>
        </button>
      </div>
...
const openFullTest = () => { sessionStorage.setItem('sdCombinedFullTestUnlocked', 'true'); router.push('/sd/test') }
