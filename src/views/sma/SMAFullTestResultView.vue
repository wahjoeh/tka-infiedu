<template>
  <div class="result-container">
    ...
    <div
      v-if="result && result.math && result.indo && result.english"
      class="result-card"
    >
      <div class="result-header">
        <div class="result-icon">📊</div>

        <h1 class="result-title">Reviu Hasil Simulasi TKA SMA</h1>
...
onMounted(() => {
  const saved = sessionStorage.getItem('smaFullTestResult')
