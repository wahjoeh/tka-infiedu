  ...
  <div class="test-container sma-math-test exam-math-theme">
    ...
    <header class="test-header">
      ...
      <div class="header-title">
        ...
        <p>TKA SMA - Biologi (Paket {{ selectedPackage }})</p>
      </div>
...
import fulltestQuestions, { questionsByCategory } from '../../../data/sma/biologi/fulltest'
...
<style>
.sma-math-test .reading-paragraph .statement-list {
