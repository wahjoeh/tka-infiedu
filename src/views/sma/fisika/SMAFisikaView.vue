<template>
  <div class="math-container">
    ...
    <div class="math-card">
      <h1 class="page-title">Latihan Fisika</h1>
      ...
      <div class="package-grid">
        <button class="package-card" @click="goToTrial"><h3>Trial</h3><p>Kerjakan 10 soal Fisika untuk mencoba kemampuanmu.</p></button>
        <button class="package-card full-test" @click="showPasswordDialog = true">
          <h3>Full Test Simulation</h3>
          <p>
            Simulasi lengkap seluruh materi Fisika TKA SMA.
          </p>
        </button>
      </div>
...
const goToTrial = () => router.push('/sma/practice/fisika/test?mode=trial')
const openFullTest = () => { if (password.value !== FULL_TEST_PASSWORD) { passwordError.value = true; return }; sessionStorage.setItem('smaFisikaFullTestUnlocked', 'true'); router.push('/sma/practice/fisika/test?mode=fulltest') }
