  ...
  <div class="indo-container">
    ...
    <div class="indo-card">
      ...
      <div class="package-grid">
        ...
        <button class="package-card full-test" @click="showPasswordDialog = true"><h3>Full Test Simulation</h3><p>Kerjakan 25 soal dari paket acak dengan kesulitan merata.</p></button>
      </div>
...
const goToTrial = () => router.push('/smp/practice/english/test?mode=trial')
const openFullTest = () => { if (password.value !== FULL_TEST_PASSWORD) { passwordError.value = true; return }; sessionStorage.setItem('smpEnglishFullTestUnlocked', 'true'); router.push('/smp/practice/english/test?mode=fulltest') }
