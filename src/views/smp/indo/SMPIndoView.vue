...
const goToTrial = () => router.push('/smp/practice/indo/test?mode=trial')
const openFullTest = () => { if (password.value !== FULL_TEST_PASSWORD) { passwordError.value = true; return }; sessionStorage.setItem('smpIndoFullTestUnlocked', 'true'); router.push('/smp/practice/indo/test?mode=fulltest') }
