  ...
  <div class="test-container smp-math-test exam-math-theme">
    ...
    <header class="test-header">
      ...
      <div class="header-title">
        ...
        <p>TKA SMP - IPA (Paket {{ selectedPackage }})</p>
      </div>
...
// CATATAN: memakai ulang stylesheet & class "smp-math-test" seperti pola
// SMABiologiTestView.vue yang menumpang "sma-math-test". Ganti path ini kalau
// project sudah punya stylesheet khusus untuk halaman tes SMP IPA.
import '../../../styles/smp-math-test.css'

import fulltestQuestions, { questionsByCategory } from '../../../data/smp/ipas/fulltest.js'

const route = useRoute()
const router = useRouter()

const QUESTION_PACKAGES = Object.values(questionsByCategory)
  .map((questionPackage) => questionPackage.map((question) => question.id))
...
// 20 soal per paket, 25 menit pengerjaan (sama seperti pola waktu di
// SMABiologiTestView.vue). Sesuaikan kalau ada durasi resmi yang berbeda.
...
const submitTest = () => {
  ...
  router.push('/result?subject=ipas')
...
<style>
.smp-math-test .reading-paragraph .statement-list {
