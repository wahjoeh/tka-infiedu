<template>
  <div class="math-container">
    ...
    <div class="math-card">
      <h1 class="page-title">Latihan IPA</h1>
      ...
      <div class="package-grid">
        <button class="package-card" @click="goToTrial"><h3>Trial</h3><p>Kerjakan 10 soal IPA untuk mencoba kemampuanmu.</p></button>
        <button class="package-card full-test" @click="showPasswordDialog = true">
          <h3>Full Test Simulation</h3>
          <p>
            Kerjakan satu paket berisi 20 soal IPA SMP.
          </p>
        </button>
      </div>
...
const goToTrial = () => router.push('/smp/practice/ipas/test?mode=trial')
const openFullTest = () => { if (password.value !== FULL_TEST_PASSWORD) { passwordError.value = true; return }; sessionStorage.setItem('smpIPASFullTestUnlocked', 'true'); router.push('/smp/practice/ipas/test?mode=fulltest') }
